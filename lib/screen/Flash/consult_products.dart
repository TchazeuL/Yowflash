...
class ConsulterProduitsScreen extends StatefulWidget {
  const ConsulterProduitsScreen(
      {super.key,
      required this.name,
      ...
      this.email,
      required this.phone});
  final String name, categorie, description, phone;
  final String? email;
  final int prix, time;

  @override
  State<StatefulWidget> createState() => _ConsulterProduitsScreen();
}

class _ConsulterProduitsScreen extends State<ConsulterProduitsScreen> {
  dynamic savedTheme;
  bool darkmode = false;
